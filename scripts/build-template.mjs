...
const PLACEHOLDERS = [
  ...
  { pattern: '"/*REPLAY_DATA*/"', token: '"__PLACEHOLDER_REPLAY_DATA__"' },
  ...
  { pattern: "/*CHECKED_REASONING*/", token: "__PLACEHOLDER_CHECKED_REASONING__" },
  { pattern: "/*CHECKED_TOOLS*/", token: "__PLACEHOLDER_CHECKED_TOOLS__" },
  { pattern: "/*CHECKED_SYSTEM*/", token: "__PLACEHOLDER_CHECKED_SYSTEM__" },
